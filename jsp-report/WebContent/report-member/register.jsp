			...
			<table>
				...
				<tr>
					<td style="width:500px;"> 
						...
						style="height:50px" onblur="chkId()">
					</td>  
				</tr>
				<tr>
				...
				<tr>
					<td> 
						<input type="text" name="pwd" id="pw" placeholder="비밀번호" class="form-control" 
						style="height:50px" onblur="chkPw()">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" name="rePwd" id="rePwd" placeholder="비밀번호 확인" class="form-control" 
						style="height:50px" onblur="chkRe()">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td> 
						...
						style="height:50px" onblur="chkName()">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" name="depart" id="depart" placeholder="부서" class="form-control" 
						style="height:50px" onblur="chkDep()">
					</td>				
				</tr>
				<tr>
				...
				<tr>
					<td> 
						<input type="text" name="rank" id="rank" placeholder="직급" class="form-control" 
						style="height:50px" onblur="chkRank()">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<br> <button type="button" onclick="chkReg()" class="btn btn-info btn-lg" 
						style="width:100%; height:50px">회원가입</button>
					</td>
				</tr>
				</tbody>
